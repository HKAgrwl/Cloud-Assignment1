from generate_random_matrix import generate_matrix
import random
import subprocess
import base64
import json
...
def assign_job(matrix_size : int, mat1 : str, mat2 : str, vm : str) -> None:
    virsh_command = """virsh -c qemu:///system qemu-agent-command %s '{"execute": "guest-exec", "arguments":{"path" : "/home/harsh/matrix_multi", "arg" : [\"%s\", \"%s\", \"%s\"], "capture-output":true}}'""" % (vm, matrix_size, mat1, mat2)
...
json.dump(final_output, open("data.json", "w"), indent=4)